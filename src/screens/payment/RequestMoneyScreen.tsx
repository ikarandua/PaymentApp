...
export const RequestMoneyScreen: React.FC<Props> = ({ navigation }) => {
  ...
  const handleRequest = async () => {
    ...
    try {
      ...
      await createPaymentRequest(user!.uid, recipient.uid, numAmount, note);

      Alert.alert('Success', `Payment request sent to ${recipient.name}`, [
        {
          text: 'Done',
      ...
      <ScrollView contentContainerStyle={styles.scrollContent}>
        ...
        <View style={styles.content}>
          <View style={styles.inputSection}>
            <Text style={styles.label}>Request from Phone Number</Text>
